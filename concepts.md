...
## 6. Server-Side Pagination with MongoDB

### Kya hai?
Saare data ko ek baar mein fetch karne ki jagah, **sirf current page ka data** fetch karo.

### Humare Project Mein (skip + limit pattern):
```js
// Page 1: skip 0, limit 8  → jobs 1-8
// Page 2: skip 8, limit 8  → jobs 9-16
// Page 3: skip 16, limit 8 → jobs 17-24
...
**URL examples:**
- `/dashboard?page=1`
- `/dashboard?page=2&search=react&status=Applied`
...
| **Pagination** | `app/dashboard/page.tsx + Pagination.tsx` | skip/limit + URL params |
...
| **MongoDB Aggregation** | `app/dashboard/page.tsx → getJobs()` | Parallel stats calculation |
